...
public class Vari : Block
{
    ...
    private void Update()
    {
        if (get == null && get2 == null && get3 == null)
        {
            ...
            GameObject temp = GameObject.Find(var);
            if (temp != null)
            {
                if (temp.GetComponent<Walker>() != null) get = temp.GetComponent<Walker>();
                if (temp.GetComponent<EnemyDrop>() != null) get2 = temp.GetComponent<EnemyDrop>();
                if (temp.GetComponent<PositionFloor1Script>() != null) get3 = temp.GetComponent<PositionFloor1Script>();
            }
        }
    }
